...
fn main() {
    ...
    let default_video_path = "output.h265".to_string();
    ...
    // ── 4. Audio output file ─────────────────────────────────────────────────
    let default_audio_path = "output.opus".to_string();
